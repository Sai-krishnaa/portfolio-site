...
/**
 * Skiper19 — scroll-driven SVG stroke
 * Paste this file to src/components/Skiper19.jsx
 * Requirements:
...
export const Skiper19 = () => {
  ...
  const { scrollYProgress } = useScroll({
    target: ref,
    // optional: adjust start/end offsets if you want the animation to start later:
...
const LinePath = ({ className, scrollYProgress }) => {
  // map scroll progress to a visible pathLength range
  const pathLength = useTransform(scrollYProgress, [0, 1], [0.5, 1]);

  // strokeDashoffset derived from pathLength so stroke draws correctly
