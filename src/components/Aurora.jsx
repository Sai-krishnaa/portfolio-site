...
"use client"; // If you are using Next.js app router. Safe to keep in plain React as well.
...
export default function Aurora(props) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // WebGL not available or failed
      console.warn("Aurora: WebGL renderer creation failed", err);
      return;
    }
    ...
    // Create a simple triangle covering the screen
    const geometry = new Triangle(gl);
    if (geometry.attributes.uv) {
      delete geometry.attributes.uv;
    }

    // convert color stops to ogl Color format
    const colorStopsArray = (colorStops || ["#3A29FF", "#FF94B4", "#FF3232"]).map(
      (hex) => {
